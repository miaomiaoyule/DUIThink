...
public:
	...
	static void DrawColor(HDC hDC, const CDUIRect &rcItem, DWORD dwColor);
	static void DrawGradient(HDC hDC, const CDUIRect &rcItem, DWORD dwFirstColor, DWORD dwSecondColor, bool bVertical, int nSteps);
