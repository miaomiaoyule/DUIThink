...
void CDUIRenderEngine::DrawRoundRect(HDC hDC, const CDUIRect &rcItem, int nXRound, int nYRound, int nSize, DWORD dwPenColor)
{
	...
	//gid+
	{
		...
		Path.AddArc(rcItem.right - nXRound * 2 - nSize, rcItem.top, nXRound * 2, nYRound * 2, 270, 90); // 右上圆角
		Path.AddLine(rcItem.right - nSize, rcItem.top + nYRound, rcItem.right - nSize, rcItem.bottom - nYRound);
		Path.AddArc(rcItem.right - nXRound * 2 - nSize, rcItem.bottom - nYRound * 2 - nSize, nXRound * 2, nYRound * 2, 0, 90); // 右下圆角
		Path.AddLine(rcItem.left + nXRound, rcItem.bottom - nSize, rcItem.right - nXRound, rcItem.bottom - nSize);
		Path.AddArc(rcItem.left, rcItem.bottom - nYRound * 2 - nSize, nXRound * 2, nYRound * 2, 90, 90); // 左下圆角
...
void CDUIRenderEngine::FillRoundRect(HDC hDC, const CDUIRect &rcItem, int nXRound, int nYRound, DWORD dwColor)
{
	...
	Path.AddLine(rcItem.left + nXRound, rcItem.top, rcItem.right - nXRound, rcItem.top);
	Path.AddArc(rcItem.right - nXRound * 2 - 1, rcItem.top, nXRound * 2, nYRound * 2, 270, 90); // 右上圆角

	Path.AddLine(rcItem.right, rcItem.top + nYRound, rcItem.right, rcItem.bottom - nYRound);
	Path.AddArc(rcItem.right - nXRound * 2 - 1, rcItem.bottom - nYRound * 2 - 1, nXRound * 2, nYRound * 2, 0, 90); // 右下圆角

	Path.AddLine(rcItem.left + nXRound, rcItem.bottom, rcItem.right - nXRound, rcItem.bottom);
	Path.AddArc(rcItem.left, rcItem.bottom - nYRound * 2 - 1, nXRound * 2, nYRound * 2, 90, 90); // 左下圆角
