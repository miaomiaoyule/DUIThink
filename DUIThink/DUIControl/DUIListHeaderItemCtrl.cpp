...
Gdiplus::ARGB CDUIListHeaderItemCtrl::GetTextColor()
{
...
void CDUIListHeaderItemCtrl::InitProperty()
{
	...
	DuiCreateAttribute(m_AttributeSepColor, _T("SepColor"), _T("分隔条颜色"), m_AttributeGroupSep);
	DuiCreateAttribute(m_AttributeSepWidth, _T("SepWidth"), _T("separator width"), m_AttributeGroupSep);
	DuiCreateAttribute(m_AttributeSepScale, _T("SepScale"), _T("分隔条比例"), m_AttributeGroupSep);
	DuiCreateAttribute(m_AttributeSepImage, _T("SepImage"), _T("分隔条背景图片"), m_AttributeGroupSep);
